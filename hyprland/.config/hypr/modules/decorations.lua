...
hl.animation({ leaf = "windowsOut",     enabled = true, speed = 4, bezier = "easeOutCubic", style = "popin 80%" })
...
hl.animation({ leaf = "workspacesIn",   enabled = true, speed = 3.5, bezier = "easeOutCubic" })
hl.animation({ leaf = "workspacesOut",  enabled = true, speed = 3.5, bezier = "easeOutCubic" })
